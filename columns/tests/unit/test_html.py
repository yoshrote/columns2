...
class TestStripHTML(unittest.TestCase):
	...
	def test_basic(self):
		...
		from columns.lib.html import striphtml
...
class TestStripObjects(unittest.TestCase):
	...
	def test_removeembededobject(self):
		# make sure the shuffled sequence does not lose any elements
		from columns.lib.html import stripobjects
...
class TestGetMetamediaData(unittest.TestCase):
	def test_blank(self):
		from columns.lib.html import get_metamedia_data
...
class TestGetPostThumbnail(unittest.TestCase):
	def test_vimeo_thumb(self):
		from columns.lib.html import get_post_thumbnail
